        ...
        <main className="py-6">
            <Container>
                ...
                <div className="space-y-2 mb-8">
                    <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Pasarman Settings</h1>
                    <p className="text-gray-600">Customize your grocery shopping experience</p>
                </div>

                {/* Main Content */}
                <Tabs defaultValue="delivery" className="space-y-6">
                    <TabsList className="flex flex-wrap gap-2 w-full mb-6 bg-transparent">
                        <TabsTrigger
                            value="delivery"
                            className="flex-1 min-w-[120px] data-[state=active]:bg-green-800 data-[state=active]:text-white"
                        >
